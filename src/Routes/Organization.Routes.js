...
const { createOrganization, joinOrganization, getOrganization, getDashboardStats } = require('../Controllers/Organization.Controller');
...
router.get('/stats', verifyTokenWithSession, getDashboardStats);
